...
class WelcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post welcomes_url, params: { welcome: { about: @welcome.about, index: @welcome.index } }
    end
  ...
  test "should update welcome" do
    patch welcome_url(@welcome), params: { welcome: { about: @welcome.about, index: @welcome.index } }
